...
export const about = {
    ...
    experience: [
        {
            name: 'Triptease',
            description: ['Associate Software Engineer, 2021 - present'],
            ...
            bio: [
                ...
                'Working on the Messages product, including the UI of the messages themselves, a rich content editor with live preview for message creation, content database and CDN, event tracking and analytics platform.',
                'My team is building the platform for hoteliers to manage their messages and crunch stats.',
    ...
    projects: [
        ...
        {
            name: 'Travel Home',
            description: 'A travel website in order to learn more about Materialize CSS',
